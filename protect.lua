...
local Window = library:AddWindow("Anti DEV | FREE", {
...
CreditTAB:AddButton("Made by Anti DEV | FREE.#0001", function(bool)
    setclipboard("Anti DEV | FREE.#0001")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("Join discord.gg/S4nPz6quZM", function(bool)
    setclipboard("https://discord.gg/S4nPz6quZM")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
pcall(function()
    game.StarterGui:SetCore("SendNotification", {
      ...
      Text = 'Join our discord, https://discord.gg/aDdRewEzDz';
      Duration = 40;
    })
    if not game.Players.LocalPlayer:IsInGroup(13635825) then
      coroutine.resume(coroutine.create(function()
         ...
         setclipboard('https://discord.gg/aDdRewEzDz')
      end))
    end
  end)